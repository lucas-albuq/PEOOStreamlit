...
class Agenda:
  ...
  def __eq__(self, x):
    if self.__id == x.__id and self.__data == x.__data and self.__confirmado == x.__confirmado and self.__nome_cliente == x.__nome_cliente and self.__id_servico == x.__id_servico:
      return True
    return False
