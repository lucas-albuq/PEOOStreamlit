...
class View:
  ...
  def agenda_inserir(data, confirmado, nome_cliente, desc_servico):
    NAgenda.inserir(Agenda(0, data, confirmado, nome_cliente, desc_servico))

  def agenda_atualizar(id, data, confirmado, nome_cliente, desc_servico):
    NAgenda.atualizar(Agenda(id, data, confirmado, nome_cliente, desc_servico))
