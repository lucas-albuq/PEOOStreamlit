...
class View:
  ...
  def agenda_inserir(data, confirmado, nome_cliente, id_servico):
    NAgenda.inserir(Agenda(0, data, confirmado, nome_cliente, id_servico))

  def agenda_atualizar(id, data, confirmado, nome_cliente, id_servico):
