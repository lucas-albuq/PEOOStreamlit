...
class NCliente:
    ...
    def abrir(cls):
        try:
            cls.__clientes = []
            with open("ListaPoo9C/Clientes.json", "r") as f:
                clientes_json = json.load(f)
                for obj in clientes_json:
                    c = Cliente(obj["_Cliente__id"], obj["_Cliente__nome"], obj["_Cliente__email"], obj["_Cliente__fone"], obs)
    ...
    @classmethod
    def salvar(cls):
        with open('ListaPoo9C/Clientes.json', 'w') as f:
